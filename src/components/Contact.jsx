  ...
  return (
    <section id="contact" className="section">
      <div className="container container--narrow">
        <span className="contact__eyebrow mono accent">04. What&apos;s Next?</span>
        <h2 className="contact__title">Get In Touch</h2>
        <p className="contact__body">
          I&apos;m open to new Data Engineering opportunities. Whether you have a cloud data platform
          to build, a pipeline to optimize, or just want to connect — my inbox is always open.
        </p>

        <a href="mailto:ishwaryaa2k1@gmail.com" className="btn btn--primary btn--lg">
          Say Hello
        </a>
        ...
        <div className="contact__links">
          ...
          <a href="mailto:ishwaryaa2k1@gmail.com" className="contact__link">
          ...
          <a href="tel:+19015388011" className="contact__link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18">
